...
float xr = 0;
float yr = 0;
float r = 0.0; //scale of shape

int pathTrajectory = 0; //path shape
...
public void RandomShape(float x, float y) {
  ...
  pathTrajectory = 0;
  defineLineEndPoints(x, y, r);
  //defineSquareEndPoints(x, y, r);
}

public void defineLineEndPoints(float x, float y, float r){
  lineEndPoints[0][0] = x;
  lineEndPoints[0][1] = y;
  lineEndPoints[1][0] = x+r;
  lineEndPoints[1][1] = y+r;
}

public void defineSquareEndPoints(float x, float y, float r){
  squareEndPoints[0][0] = x;
  squareEndPoints[0][1] = y;
  squareEndPoints[1][0] = x+r;
  squareEndPoints[1][1] = y;
  squareEndPoints[2][0] = x+r;
  squareEndPoints[2][1] = y+r;
  squareEndPoints[3][0] = x;
  squareEndPoints[3][1] = y+r;
}
...
while(1==1) {
    ...
    timesincelastloop=starttime-timetaken;
    iter+= 1;
